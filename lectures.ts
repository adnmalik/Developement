...
function hello () {console.log(`Good morning`);
}
hello();
...
function greet2 (fname: string , lastName: string) {console.log(`Hello` +" " + fname +" "+ lastName)
}
...
function addition( a: number , b : number) {console.log (a+b);
}
...
function sum (n1: number, n2: number) {console.log(n1+n2);
}
function subtarct (n1: number , n2 : number) {console.log(n1-n2);
}
function divion(n1:number, n2 : number){console.log(n1/n2);
}
function multiplication(n1: number , n2 : number){console.log(n1*n2);
}
divion(12,13);
...
function prime (n1: number) {if (n1%2==0 ){console.log(`this is prime number`)
}
else {
